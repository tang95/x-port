...
type ComponentRepo interface {
	...
	ListDependency(ctx context.Context, id string, filter *domain.ListComponentFilter, page *domain.PageQuery) ([]*domain.Component, int32, error)
	// ListDependents 列出依赖我的组件
	ListDependents(ctx context.Context, id string, filter *domain.ListComponentFilter, page *domain.PageQuery) ([]*domain.Component, int32, error)
}
